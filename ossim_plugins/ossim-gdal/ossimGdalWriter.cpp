   ...
   if(geom.valid())
   {
    ...
    //  const ossimMapProjection* mapProj =
      ...
      if (mapProj != NULL)
      {
		...
		//wktString="PROJCS[\"unnamed\",GEOGCS[\"Unknown - PCI E012\",DATUM[\"Unknown - PCI E012\",SPHEROID[\"WGS 84\",6378137,298.257223563,AUTHORITY[\"EPSG\",\"7030\"]]],PRIMEM[\"Greenwich\",0],UNIT[\"degree\",0.0174532925199433]],PROJECTION[\"Transverse_Mercator\"],PARAMETER[\"latitude_of_origin\",0],PARAMETER[\"central_meridian\",45],PARAMETER[\"scale_factor\",1],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",0]]";
