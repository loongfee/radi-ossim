...
//
//*****************************************************************************
// $Id: ossimTheosDimapSupportData.h 17814 2014-03-01 12:44:02Z $
#ifndef ossimTheosDimapSupportData_HEADER
#define ossimTheosDimapSupportData_HEADER
...
class ossimTheosDimapSupportData : public ossimObject,
                                  public ossimErrorStatusInterface
{
public:

   /** metadata.dim format version */
   enum ossimTheosMetadataVersion
   {
      OSSIM_THEOS_METADATA_VERSION_UNKNOWN = 0,
      OSSIM_THEOS_METADATA_VERSION_1_0 = 1,
      OSSIM_THEOS_METADATA_VERSION_1_1 = 2
   };

   ossimTheosDimapSupportData();


   ossimTheosDimapSupportData(const ossimTheosDimapSupportData& rhs);
   ossimTheosDimapSupportData(const ossimFilename& dimapFile,
   ...
   //---
   void getAttitude(ossim_uint32 sample, std::vector<ossim_float64>& quaternion)  const;
   void getAttitude(const ossim_float64& time, std::vector<ossim_float64>& quaternion) const;
   ...
   void getPixelLookAngleY (const ossim_float64& sample,
                            ossim_float64& pa) const;
   ossimDpt3d getAttitudeBias ()const {return theAttitudeBias;};
   ...
   virtual bool loadState(const ossimKeywordlist& kwl,
                          const char* prefix = 0);
protected:
   virtual ~ossimTheosDimapSupportData();
...
private:
   ...
   void extrapolateAttitude(const ossim_float64& time, std::vector<ossim_float64>& quaternion) const;


   ossimString                 theSensorID;
   ossimTheosMetadataVersion    theMetadataVersion;
   ...
   std::vector<ossim_float64>  thePixelLookAngleX_coefs;
   std::vector<ossim_float64>  thePixelLookAngleY_coefs;
   std::vector<ossimDpt3d>     theAttitudeSamples; // x=pitch, y=roll, z=yaw
   std::vector< vector<ossim_float64> > theQuaternions;	  // Q0, Q1, Q2, Q3
   ossimDpt3d                  theAttitudeBias; // x=pitch, y=roll, z=yaw
