...
// Description:
//
// Contains declaration of class radiCbers04SupportData.
//
//*****************************************************************************
// $Id: radiCbers04SupportData.h $
#ifndef radiCbers04SupportData_HEADER
#define radiCbers04SupportData_HEADER
...
class OSSIM_PLUGINS_DLL radiCbers04SupportData : public ossimObject,
...
public:
   ...
   radiCbers04SupportData(const radiCbers04SupportData& rhs);
   radiCbers04SupportData(const ossimFilename& dimapFile,
...
protected:
	virtual ~radiCbers04SupportData();
