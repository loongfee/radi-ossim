#ifndef ossimHj1Model_HEADER
#define ossimHj1Model_HEADER
#include <iostream>
using namespace std;
...
#include <ossim_plugin/radi/ossimQVProcSupportData.h>
...
class OSSIM_PLUGINS_DLL ossimHj1Model : public ossimSensorModel
{
public:
   /*!
    * CONSTRUCTORS:
    */
   ossimHj1Model();
   ossimHj1Model(ossimQVProcSupportData* sd);
   ossimHj1Model(radiQVProcSupportData* sd);
   ossimHj1Model(const ossimFilename& init_file);
   ossimHj1Model(const ossimKeywordlist& geom_kwl);
   ossimHj1Model(const ossimHj1Model& rhs);
   virtual ~ossimHj1Model();
...
#endif /* #ifndef ossimHj1Model_HEADER */
