...
#include <ossim/projection/ossimRpcXyz2RcModel.h>
#include <ossim/projection/ossimRpcRcz2XyModel.h>
...
public:
	...
	//void solveCoefficients_Rcz2Xy(const std::vector<ossimDpt>& imagePoints,
	//	const std::vector<ossimGpt>& groundControlPoints,
	//	const ossimDpt& imageShift = ossimDpt(0.0,0.0));
};
#endif
