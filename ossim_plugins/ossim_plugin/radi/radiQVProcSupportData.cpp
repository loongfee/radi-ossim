#include "radiQVProcSupportData.h"
...
namespace ossimplugins{
	...
	static ossimTrace traceDebug ("radiQVProcSupportData:debug");

	static const ossim_uint32  LAGRANGE_FILTER_SIZE = 8; // num samples considered

	radiQVProcSupportData::radiQVProcSupportData ()
		:
	...
	radiQVProcSupportData::radiQVProcSupportData(const radiQVProcSupportData& rhs)
	...
	radiQVProcSupportData::radiQVProcSupportData (const ossimFilename& descFile, bool  processSwir)
		:
		ossimErrorStatusInterface(),
		theMetadataVersion(OSSIM_QVProc_VERSION_UNKNOWN),
		theImageID(),
	...
	ossimObject* radiQVProcSupportData::dup()const
	{
		return new radiQVProcSupportData(*this);
	}

	void radiQVProcSupportData::clearFields()
	{
		clearErrorStatus();
		//theSensorID="Spot 5";
		theSensorID="";
	...
	bool radiQVProcSupportData::parseQVProcFile(const ossimFilename& file,
		bool processSwir/*=false*/)
	{
		static const char MODULE[] = "radiQVProcSupportData::parseQVProcFile";
		if(traceDebug())
		{
			ossimNotify(ossimNotifyLevel_DEBUG)
				<< MODULE << " DEBUG:"
	...
	string radiQVProcSupportData::time2String(const _TIMESTAMP& t)const
	{
	...
	bool radiQVProcSupportData::readHeadInfo(fstream& fs, QUIVIMAGE_HEAD_INFO& header)
	{
		//	接收该数据的地面站的标识 16
	...
	bool radiQVProcSupportData::readTimeInfo(fstream& fs, _TIMESTAMP& t)
	{
		//	year 4
	...
	bool radiQVProcSupportData::readSAT_POS(fstream& fs, SAT_POS& pos)
	{
		//	x 4
	...
	bool radiQVProcSupportData::readSAT_ATT(fstream& fs, SAT_ATT& att)
	{
		//	roll 4
	...
	void radiQVProcSupportData::BitInverse(char* chrs, int nBit)
	{
	...
	bool radiQVProcSupportData::readQuivAuxInfo(fstream& fs, QUIVIMAGE_AUX_INFO& aux)
	{
		bool bState = true;
	...
	bool radiQVProcSupportData::saveState(ossimKeywordlist& kwl,
	...
	bool radiQVProcSupportData::loadState(const ossimKeywordlist& kwl,
		const char* prefix)
	{
		clearFields();
	...
	ossimGpt radiQVProcSupportData::createGround(const ossimString& s)const
	{
	...
	ossimDpt radiQVProcSupportData::createDpt(const ossimString& s)const
	{
		std::istringstream in(s.string());
		ossimString x, y;
		ossimString code;
	...
	void radiQVProcSupportData::printInfo(ostream& os) const
	{
	...
	ossimString radiQVProcSupportData::getSensorID() const
	{
		return theSensorID;
	}

	ossimString radiQVProcSupportData::getSpacecraftID() const
	{
		return theSpacecraftID;
	}

	ossimString radiQVProcSupportData::getStationID() const
	{
		return theStationID;
	}

	ossimString   radiQVProcSupportData::getMetadataVersionString() const
	{
	...
	ossimString radiQVProcSupportData::getAcquisitionDate() const
	{
		return theAcquisitionDate;
	}

	ossimString radiQVProcSupportData::getProductionDate() const
	{
		return theProductionDate;
	}

	ossimString radiQVProcSupportData::getImageID() const
	{
		return theImageID;
	}

	ossimFilename radiQVProcSupportData::getMetadataFile() const
	{
		return theMetadataFile;
	}

	ossimString radiQVProcSupportData::getInstrument() const
	{
		return theInstrument;
	}

	ossim_uint32 radiQVProcSupportData::getInstrumentIndex() const
	{
		return theInstrumentIndex;
	}

	void radiQVProcSupportData::getSunAzimuth(ossim_float64& az) const
	{
		az = theSunAzimuth;
	}

	void radiQVProcSupportData::getSunElevation(ossim_float64& el) const
	{
		el = theSunElevation;
	}

	void radiQVProcSupportData::getImageSize(ossimDpt& sz) const
	{
		sz = theImageSize;
	}

	void radiQVProcSupportData::getLineSamplingPeriod(ossim_float64& pe) const
	{
		pe = theLineSamplingPeriod;
	}


	void radiQVProcSupportData::getRefImagingTime(ossim_float64& t) const
	{
		t = theReferenceTime;
	}

	void radiQVProcSupportData::getRefImagingTimeLine(ossim_float64& tl) const
	{
		tl = theReferenceTimeLine;
	}

	bool radiQVProcSupportData::isStarTrackerUsed() const
	{
		return theStarTrackerUsed;
	}

	bool radiQVProcSupportData::isSwirDataUsed() const
	{
		return theSwirDataFlag;
	}

	ossim_uint32 radiQVProcSupportData::getNumberOfBands() const
	{
		return theNumBands;
	}

	ossim_uint32 radiQVProcSupportData::getStepCount() const
	{
		return theStepCount;
	}

	void radiQVProcSupportData::getIncidenceAngle(ossim_float64& ia) const
	{
		ia = theIncidenceAngle;
	}

	void radiQVProcSupportData::getViewingAngle(ossim_float64& va) const
	{
		va = theViewingAngle;
	}

	void radiQVProcSupportData::getSceneOrientation(ossim_float64& so) const
	{
		so = theSceneOrientation;
	}

	void radiQVProcSupportData::getRefGroundPoint(ossimGpt& gp) const
	{
		gp = theRefGroundPoint;
	}

	void radiQVProcSupportData::getRefImagePoint(ossimDpt& rp) const
	{
		rp = theRefImagePoint;
	}

	ossim_uint32 radiQVProcSupportData::getNumSamples() const
	{
		return (ossim_uint32)theLineSamples.size();
	}

	ossim_uint32 radiQVProcSupportData::getNumGeoPosPoints() const
	{
		return (ossim_uint32)theGeoPosImagePoints.size();
	}

	void radiQVProcSupportData::getUlCorner(ossimGpt& pt) const
	{
		pt = theUlCorner;
	}

	void radiQVProcSupportData::getUrCorner(ossimGpt& pt) const
	{
		pt = theUrCorner;
	}

	void radiQVProcSupportData::getLrCorner(ossimGpt& pt) const
	{
		pt = theLrCorner;
	}

	void radiQVProcSupportData::getLlCorner(ossimGpt& pt) const
	{
		pt = theLlCorner;
	}

	void radiQVProcSupportData::getImageRect(ossimDrect& rect)const
	{
		rect = ossimDrect(0.0, 0.0, theImageSize.x - 1.0, theImageSize.y - 1.0);
	}

	void radiQVProcSupportData::getSubImageOffset(ossimDpt& offset) const
	{
