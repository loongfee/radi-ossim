...
// Description:
//
// Contains declaration of class radiQVProcSupportData.
//
//*****************************************************************************
// $Id: radiQVProcSupportData.h $
#ifndef radiQVProcSupportData_HEADER
#define radiQVProcSupportData_HEADER
...
class OSSIM_PLUGINS_DLL radiQVProcSupportData : public ossimObject,
...
public:
   ...
   radiQVProcSupportData();


   radiQVProcSupportData(const radiQVProcSupportData& rhs);
   radiQVProcSupportData(const ossimFilename& dimapFile,
