#ifndef radiRpcModel_HEADER
#define radiRpcModel_HEADER
 ...
 *
 *****************************************************************************/
class OSSIM_PLUGINS_DLL radiRpcModel : public ossimSensorModel
{
public:
   //***
   ...
   radiRpcModel(const radiRpcModel& copy_this);
   ...
   void setUseL1(bool b) {m_bUseL1 = b;};
protected:
