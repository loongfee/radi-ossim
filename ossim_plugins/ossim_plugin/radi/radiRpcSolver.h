...
#ifndef radiRpcSolver_HEADER
#define radiRpcSolver_HEADER
 ...
 * 
 */ 
class OSSIM_PLUGINS_DLL radiRpcSolver : public ossimReferenced
{
public:
   /**
    ...
    */
	...
	typedef enum{
		...
		LS,
		METHOD_NUM,
	} EstimationMethodIndex;

   radiRpcSolver(bool useElevation=false,
   ...
   void denormalize(ossimDpt &dpt);
protected:
	virtual ~radiRpcSolver(){}
   
   virtual void solveInitialCoefficients(arma::vec& coeff,
                                         const std::vector<double>& f,
                                         const std::vector<double>& x,
                                         const std::vector<double>& y,
                                         const std::vector<double>& z)const;
                                         
   virtual void solveCoefficients(arma::vec& coeff,
                                  const std::vector<double>& f,
                                  const std::vector<double>& x,
                                  const std::vector<double>& y,
                                  const std::vector<double>& z)const;

   void solveAllCoefficients(arma::vec& coeff,
   ...
   void setupSystemOfEquations(arma::mat& equations,
                               const arma::vec& f,
                               const std::vector<double>& x,
                               const std::vector<double>& y,
                               const std::vector<double>& z)const;
