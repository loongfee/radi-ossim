#include "radiCbers04SupportData.h"
...
namespace ossimplugins{
	...
	static ossimTrace traceDebug ("radiCbers04SupportData:debug");

	static const ossim_uint32  LAGRANGE_FILTER_SIZE = 8; // num samples considered

	radiCbers04SupportData::radiCbers04SupportData ()
		:
	...
	radiCbers04SupportData::radiCbers04SupportData(const radiCbers04SupportData& rhs)
	...
	radiCbers04SupportData::radiCbers04SupportData (const ossimFilename& descFile, bool  processSwir)
		:
		ossimErrorStatusInterface(),
		theMetadataVersion(OSSIM_QVProc_VERSION_UNKNOWN),
		theImageID(),
	...
	ossimObject* radiCbers04SupportData::dup()const
	{
		return new radiCbers04SupportData(*this);
	}

	void radiCbers04SupportData::clearFields()
	{
		clearErrorStatus();
		//theSensorID="Spot 5";
		theSensorID="";
	...
	bool radiCbers04SupportData::parseQVProcFile(const ossimFilename& file,
		bool processSwir/*=false*/)
	{
		static const char MODULE[] = "radiCbers04SupportData::parseQVProcFile";
		if(traceDebug())
		{
			ossimNotify(ossimNotifyLevel_DEBUG)
				<< MODULE << " DEBUG:"
	...
	string radiCbers04SupportData::time2String(const _TIMESTAMP& t)const
	{
	...
	bool radiCbers04SupportData::readHeadInfo(fstream& fs, QUIVIMAGE_HEAD_INFO& header)
	{
		//	接收该数据的地面站的标识 16
	...
	bool radiCbers04SupportData::readTimeInfo(fstream& fs, _TIMESTAMP& t)
	{
		//	year 4
	...
	bool radiCbers04SupportData::readSAT_POS(fstream& fs, SAT_POS& pos)
	{
		//	x 4
	...
	bool radiCbers04SupportData::readSAT_ATT(fstream& fs, SAT_ATT& att)
	{
		//	roll 4
	...
	void radiCbers04SupportData::BitInverse(char* chrs, int nBit)
	{
	...
	bool radiCbers04SupportData::readQuivAuxInfo(fstream& fs, QUIVIMAGE_AUX_INFO& aux)
	{
		bool bState = true;
	...
	bool radiCbers04SupportData::saveState(ossimKeywordlist& kwl,
		const char* prefix)const
	{
		kwl.add(prefix,
			ossimKeywordNames::TYPE_KW,
			"radiCbers04SupportData",
			true);
	...
	bool radiCbers04SupportData::loadState(const ossimKeywordlist& kwl,
		const char* prefix)
	{
		clearFields();
	...
	ossimGpt radiCbers04SupportData::createGround(const ossimString& s)const
	{
	...
	ossimDpt radiCbers04SupportData::createDpt(const ossimString& s)const
	{
		std::istringstream in(s.string());
		ossimString x, y;
		ossimString code;
	...
	void radiCbers04SupportData::printInfo(ostream& os) const
	{
	...
	ossimString radiCbers04SupportData::getSensorID() const
	{
		return theSensorID;
	}

	ossimString radiCbers04SupportData::getSpacecraftID() const
	{
		return theSpacecraftID;
	}

	ossimString radiCbers04SupportData::getStationID() const
	{
		return theStationID;
	}

	ossimString   radiCbers04SupportData::getMetadataVersionString() const
	{
	...
	ossimString radiCbers04SupportData::getAcquisitionDate() const
	{
		return theAcquisitionDate;
	}

	ossimString radiCbers04SupportData::getProductionDate() const
	{
		return theProductionDate;
	}

	ossimString radiCbers04SupportData::getImageID() const
	{
		return theImageID;
	}

	ossimFilename radiCbers04SupportData::getMetadataFile() const
	{
		return theMetadataFile;
	}

	ossimString radiCbers04SupportData::getInstrument() const
	{
		return theInstrument;
	}

	ossim_uint32 radiCbers04SupportData::getInstrumentIndex() const
	{
		return theInstrumentIndex;
	}

	void radiCbers04SupportData::getSunAzimuth(ossim_float64& az) const
	{
		az = theSunAzimuth;
	}

	void radiCbers04SupportData::getSunElevation(ossim_float64& el) const
	{
		el = theSunElevation;
	}

	void radiCbers04SupportData::getImageSize(ossimDpt& sz) const
	{
		sz = theImageSize;
	}

	void radiCbers04SupportData::getLineSamplingPeriod(ossim_float64& pe) const
	{
		pe = theLineSamplingPeriod;
	}


	void radiCbers04SupportData::getRefImagingTime(ossim_float64& t) const
	{
		t = theReferenceTime;
	}

	void radiCbers04SupportData::getRefImagingTimeLine(ossim_float64& tl) const
	{
		tl = theReferenceTimeLine;
	}

	bool radiCbers04SupportData::isStarTrackerUsed() const
	{
		return theStarTrackerUsed;
	}

	bool radiCbers04SupportData::isSwirDataUsed() const
	{
		return theSwirDataFlag;
	}

	ossim_uint32 radiCbers04SupportData::getNumberOfBands() const
	{
		return theNumBands;
	}

	ossim_uint32 radiCbers04SupportData::getStepCount() const
	{
		return theStepCount;
	}

	void radiCbers04SupportData::getIncidenceAngle(ossim_float64& ia) const
	{
		ia = theIncidenceAngle;
	}

	void radiCbers04SupportData::getViewingAngle(ossim_float64& va) const
	{
		va = theViewingAngle;
	}

	void radiCbers04SupportData::getSceneOrientation(ossim_float64& so) const
	{
		so = theSceneOrientation;
	}

	void radiCbers04SupportData::getRefGroundPoint(ossimGpt& gp) const
	{
		gp = theRefGroundPoint;
	}

	void radiCbers04SupportData::getRefImagePoint(ossimDpt& rp) const
	{
		rp = theRefImagePoint;
	}

	ossim_uint32 radiCbers04SupportData::getNumSamples() const
	{
		return (ossim_uint32)theLineSamples.size();
	}

	ossim_uint32 radiCbers04SupportData::getNumGeoPosPoints() const
	{
		return (ossim_uint32)theGeoPosImagePoints.size();
	}

	void radiCbers04SupportData::getUlCorner(ossimGpt& pt) const
	{
		pt = theUlCorner;
	}

	void radiCbers04SupportData::getUrCorner(ossimGpt& pt) const
	{
		pt = theUrCorner;
	}

	void radiCbers04SupportData::getLrCorner(ossimGpt& pt) const
	{
		pt = theLrCorner;
	}

	void radiCbers04SupportData::getLlCorner(ossimGpt& pt) const
	{
		pt = theLlCorner;
	}

	void radiCbers04SupportData::getImageRect(ossimDrect& rect)const
	{
		rect = ossimDrect(0.0, 0.0, theImageSize.x - 1.0, theImageSize.y - 1.0);
	}

	void radiCbers04SupportData::getSubImageOffset(ossimDpt& offset) const
	{
