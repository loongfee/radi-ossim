...
static ossimString BJ54 = "BJ54";
static ossimString XiAn80 = "XiAn80";
...
void ossimDatumFactory::initializeDefaults()
{
   ...
   ////////////
   theDatumTable.insert(std::make_pair(BJ54.string(), new ossimBj54Datum));
   theDatumTable.insert(std::make_pair(XiAn80.string(), new ossimXiAn80Datum));
   //////////////////wwadd
   ...
   while( std::strlen(threeParamDatum[idx].theCode) )
   {
      if( (threeParamDatum[idx].theCode != WGE) &&
		  ...
		  (threeParamDatum[idx].theCode != BJ54) &&
		  (threeParamDatum[idx].theCode != XiAn80))
      {
