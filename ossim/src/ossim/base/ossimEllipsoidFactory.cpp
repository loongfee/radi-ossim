...
void ossimEllipsoidFactory::initializeTable()
{
   ...
   theEpsgTable.insert(std::make_pair(7059, std::string("PV")));
	  ...
	  theEllipsoidTable.insert(std::make_pair(std::string("XA"),
		  new ossimEllipsoid(std::string("XiAn80"), std::string("XA"),
   ...
   theWgs72Ellipsoid = new ossimEllipsoid(std::string("WGS 72"), std::string("WD"), 
	   6378135.000, 6356750.5200, 7043);
   theBj54Ellipsoid = new ossimEllipsoid(std::string("Krassovsky"), std::string("KA"), 
	   6378245.0, 6356863.0190);
   theXiAn80Ellipsoid = new ossimEllipsoid(std::string("XiAn80"), std::string("XA"),
	   6378140.0, 6356755.2882);
}
...
void ossimEllipsoidFactory::deleteAll()
{
   ...
   if (theBj54Ellipsoid)
   {
	   delete theBj54Ellipsoid;
	   theBj54Ellipsoid = 0;
   }
   if (theXiAn80Ellipsoid)
   {
	   delete theXiAn80Ellipsoid;
	   theXiAn80Ellipsoid = 0;
   }
}
