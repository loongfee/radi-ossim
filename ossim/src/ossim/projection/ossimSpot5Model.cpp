...
void ossimSpot5Model::computeSatToOrbRotation(NEWMAT::Matrix& result, long double t)const
{
   if (traceExec())
   {
   ...
   //---
   long double dt = theRefImagingTime - t;
                                 ...
                                 ossimEcefRay&   image_ray) const
{
   ...
   //
   long double delta_t = (long double)(theLineSamplingPeriod)*(long double)(iPt.line - theRefImagingTimeLine);
   //double t_line = theRefImagingTime +
   //                (long double)(theLineSamplingPeriod)*(long double)(iPt.line - theRefImagingTimeLine);
   //long double t_line = theRefImagingTime + delta_t;
   long double t_line = delta_t;
