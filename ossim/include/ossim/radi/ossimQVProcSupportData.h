...
class ossimQVProcSupportData : public ossimObject,
...
public:
   ...
   ossim_float64    getSampTime(int idx)const {return theSampTimes[idx]+theSampTimesBias[idx]*1e-3;}
   ossimDpt3d    getAttitude(int idx)const {return theAttitudeSamples[idx]+theAttitudeBias[idx]*1e-4;}
   ossimDpt3d    getAttitudeVel(int idx)const {return theAttitudeVelSamples[idx]+theAttitudeVelBias[idx]*1e-4;}
protected:
...
private:
   ...
   std::vector<ossim_float64>  theSampTimes;
