...
void ossimTransMercatorProjection::setZone(const ossimGpt& ground)
{
...
void ossimTransMercatorProjection::setZone(ossim_int32 zone)
{
   if( (zone < 1) || (zone > 60) )
   {
...
ossim_int32 ossimTransMercatorProjection::computeZone(const ossimGpt& ground)
{
...
double ossimTransMercatorProjection::computeZoneMeridian(ossim_int32 zone)
{
   return (6.0 * zone - 3.0);;
}
