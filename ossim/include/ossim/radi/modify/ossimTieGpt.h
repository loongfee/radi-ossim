...
public:
   ...
   inline ossimTieGpt(const ossimGpt& aPt, const ossimDpt& aTie, const ossim_float64& aScore, const ossimString& aGcpNumberID="") : 
      ossimReferenced(),
      ossimGpt(aPt),
      tie(aTie),
	  score(aScore),
   ...
   inline const ossimString& getGcpNumberID()const             { return GcpNumberID; }
