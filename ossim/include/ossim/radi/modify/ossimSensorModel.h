...
#include <ossim/base/ossimTieFeature.h>
...
protected:
   ...
   double parameters_optimization(const vector< ossimTieFeature >& tieFeatureList, double* targetVariance/* = 0*/);
   double levmar_optimization(const vector< ossimTieFeature >& tieFeatureList, double* targetVariance/* = 0*/);
