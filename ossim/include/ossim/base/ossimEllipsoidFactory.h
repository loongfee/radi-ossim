...
public:
   ...
   const ossimEllipsoid* bj54()const{return theBj54Ellipsoid;}
   const ossimEllipsoid* xian80()const{return theXiAn80Ellipsoid;}
...
private:
   ...
   ossimEllipsoid*       theBj54Ellipsoid;
   ossimEllipsoid*       theXiAn80Ellipsoid;
