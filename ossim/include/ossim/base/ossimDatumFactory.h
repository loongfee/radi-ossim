...
class ossimString;
////////
class ossimBj54Datum;
class ossimXiAn80Datum;
///////////wwadd
...
public:
   ...
   const ossimDatum* bj54()const{ return theBj54Datum; }
   const ossimDatum* xa80()const{ return theXA80Datum; }
...
protected:
   ...
   const ossimDatum*               theBj54Datum;//wwadd
   const ossimDatum*               theXA80Datum;
