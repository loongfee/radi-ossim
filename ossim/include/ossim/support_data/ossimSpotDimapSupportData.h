...
public:
   ...
   void getRefLineTime(long double& rt)       const;
   ...
   void getPositionEcf(const long double& time, ossimEcefPoint& pe) const;
   void getVelocityEcf(ossim_uint32 sample, ossimEcefPoint& ve) const;
   void getVelocityEcf(const long double& time, ossimEcefPoint& ve) const;
   ...
   void getAttitude(const long double& time, ossimDpt3d& at) const;
...
private:
	void getLagrangeInterpolation(const long double& t,
                                 const std::vector<ossimDpt3d>& V,
								 const std::vector<long double>& T,
                                 ossimDpt3d& li )const;

	void getBilinearInterpolation(const long double& t,
                                 const std::vector<ossimDpt3d>& V,
								 const std::vector<long double>& T,
                                 ossimDpt3d& li )const;
   ...
   void extrapolateAttitude(const long double& time, ossimDpt3d& at) const;
   ...
   std::vector<long double>  theAttSampTimes;
   std::vector<ossimDpt3d>     theAttitudeSpeedSamples; // x=pitch, y=roll, z=yaw
   std::vector<long double>  theAttSpeedSampTimes;
   std::vector<ossimDpt3d>     thePosEcfSamples;
   std::vector<ossimDpt3d>     theVelEcfSamples;
   std::vector<long double>  theEphSampTimes;
